...
mimic_disease_word_list = [['atelect'], ['cardiomegaly'], ['consolidation'], ['pulmonaryedema'], ['shadow-enlarged'],
                      ['fracture'], ['mass', 'nodule'], ['opacity-lung', 'density-lung'], ['no-finding'], ['effusion'],
                      ['pleural-other', 'thickening-pleura', 'cicatrix-pleura', ],
...
for entry in meta_data_df.values.tolist():
    ...
    data_list_entry.append(mesh_words)
    nofinding_sign = 0
...
annotation_df.to_csv(os.path.join(data_folder, 'front_label_list_negbio.csv'), doublequote=True, index=False)